...
const WHITELIST_ROWS = [
  { id: '1', phone_number: '+14155550132', label: 'Mom', created_at: new Date(Date.now() - 41 * 86400000).toISOString(), preferred_language: 'en' as const, gender: 'female' as const },
  { id: '2', phone_number: '+16285550198', label: 'Alex (work)', created_at: new Date(Date.now() - 29 * 86400000).toISOString(), preferred_language: 'es' as const, gender: 'unknown' as const },
  { id: '3', phone_number: '+442075550199', label: '', created_at: new Date(Date.now() - 12 * 86400000).toISOString(), preferred_language: 'he' as const, gender: 'male' as const },
];
